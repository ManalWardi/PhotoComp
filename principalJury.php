...
<head>
 ...
 <div class="container mt-4">
    <h1>Bienvenue sur la page principale des jurys de PhotoComp</h1>
    <p>Dans cette page vous pouvez visualiser les photos des participants, les évaluer et ajouter des reviews sur les posts des participants.</p>
  </div>
 </div>
</div>
