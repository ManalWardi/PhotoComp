...
<body>
    ...
    <section class="view-post">
        ...
        <div class="heading">
            <h1>post details</h1> <a href="all_posts.php" class="inline-option-btn"
    ...
    <section class="reviews-container">
        ...
        <div class="heading">
            <h1>user's reviews</h1> <a href="add_review.php?idPar=<?= $idPar; ?>" class="inline-btn"
        ...
        <div class="box-container">
            ...
            while($fetch_jury=$verify_jury->fetch(PDO::FETCH_ASSOC)){
            ...
            ?>
            <div class="box" <?php /* if ($fetch_review['idJury'] == $idJury) {
                                    echo 'style="order: -1;"';
                                }*/ ?>>
                <?php
